...
def pytest_addoption(parser):
    ...
    parser.addoption('--language', action='store', default="en",
                     help="Choose language from the list: "
                          "ar, ca, cs, da, de, en, el, es, fi, fr,it, ko, nl, pl, pt, pt-br, ro, ru, sk, uk, zh-hans"
                     )
...
def browser(request):
    ...
    print("\nChecking language..")
    if browser_language in ["ar", "ca", "cs", "da", "de", "en", "el", "es", "fi", "fr", "it", "ko", "nl", "pl", "pt",
                            "pt-br", "ro", "ru", "sk", "uk", "zh-hans"]:
        print("\nstart selected browser for test..")
    else:
